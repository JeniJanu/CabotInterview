...
public class LearnClass {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		try {
			...
			extent
            .addSystemInfo("Host Name", "Amazon")
	      ...
	      //  htmlReporter.config().setTimeStampFormat("EEEE, MMMM dd, yyyy, hh:mm a '('zzz')'");
			...
			logger = extent.startTest("Test Step 1");
	        Assert.assertTrue(true);

			logger.log(LogStatus.PASS, "Amazon login was succesful");
			...
			logger = extent.startTest("Test Step 2");
	        Assert.assertTrue(true);

			logger.log(LogStatus.PASS, "Amazon login was succesful");
			extent.endTest(logger);
			/*
			 * test = extent.createTest("Test Step 2", "Smartwatch search Success");
			 * Assert.assertTrue(true); test.log(Status.PASS, "Smartwatch search Success");
			 */
			...
			/*
			 * test = extent.createTest("Test Step 3", "Smartwatch added to cart");
			 * Assert.assertTrue(true); test.log(Status.PASS, "Smartwatch added to cart");
			 */
			...
			/*
			 * test = extent.createTest("Test Step 4",
			 * "Fill in the delivery address Passed"); Assert.assertTrue(true);
			 * test.log(Status.PASS, "Fill in the delivery address Passed");
			 */
			...
			/*
			 * test = extent.createTest("Test Step 5", "PAYMENT PAGE NAVIGATED");
			 * Assert.assertTrue(true); test.log(Status.PASS, "PAYMENT PAGE NAVIGATED");
			 */
